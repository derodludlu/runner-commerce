...
export default async function seedOrders(prisma: PrismaTransaction) {
  ...
  const orders = [
    {
      ...
      items: [
        ...
        {
          listingId: listings.find(
            (l) => l.product.name === 'Whole Wheat Bread',
          )?.id!,
          productId: listings.find(
            (l) => l.product.name === 'Whole Wheat Bread',
          )?.productId!,
          quantity: 3,
          unitPrice: 2.86,
        ...
        {
          listingId: listings.find(
            (l) => l.product.name === 'Free Range Eggs (12 pack)',
          )?.id!,
          productId: listings.find(
            (l) => l.product.name === 'Free Range Eggs (12 pack)',
          )?.productId!,
    ...
    },
    {
      ...
      items: [
        ...
        {
          listingId: listings.find(
            (l) => l.product.name === 'Portable Power Bank 20000mAh',
          )?.id!,
          productId: listings.find(
            (l) => l.product.name === 'Portable Power Bank 20000mAh',
          )?.productId!,
    ...
    },
    {
      ...
      items: [
        {
          listingId: listings.find(
            (l) => l.product.name === 'Organic Quinoa 500g',
          )?.id!,
          productId: listings.find(
            (l) => l.product.name === 'Organic Quinoa 500g',
          )?.productId!,
        ...
        {
          listingId: listings.find(
            (l) => l.product.name === 'Cold Pressed Olive Oil 500ml',
          )?.id!,
          productId: listings.find(
            (l) => l.product.name === 'Cold Pressed Olive Oil 500ml',
          )?.productId!,
        ...
        {
          listingId: listings.find(
            (l) => l.product.name === 'Organic Honey 350g',
          )?.id!,
          productId: listings.find(
            (l) => l.product.name === 'Organic Honey 350g',
          )?.productId!,
